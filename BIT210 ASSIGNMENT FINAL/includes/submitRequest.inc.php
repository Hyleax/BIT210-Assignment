...
if (isset($_POST['submitRequest-btn'])){
    ...
    if ($requestType === "tutorial"){
        ...
        createTutorialRequest($connection, $staffID, $schoolID, $tutorialDescription, $tutorialTime, $studentLevel, $noOfStudents);
    ...
    if ($requestType === 'resource'){
        ...
        createResourceRequest($connection, $staffID, $schoolID, $resourceDescription, $resourceType, $noOfResources);
    }
